...
var y = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-C1aScSTo-ZJYIYUY2.js")).iosTransitionAnimation : (await import("./p-DIE4pXMl-32CC6JRD.js")).mdTransitionAnimation;
};
var h = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-CtukzcyX.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2HNFBCQD.js.map
